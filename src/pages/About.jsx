          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {values.map((v, i) => (
              ...
              >
                ...
                <div className="w-12 h-12 rounded-xl bg-brand-100 text-brand-600 flex items-center justify-center mx-auto mb-5 border border-brand-200 group-hover:border-brand-300 group-hover:scale-110 transition-all duration-500 relative z-10">
                  {v.icon}
                </div>
            ...
            <div className="space-y-12">
              {[
                ...
                },
                {
                  year: '2026',
                  title: '全面布局',
                  desc: '三大业务线成型，VR/AR + 无人机训练已落地，政企智能助手（GraphRAG 政务级智能服务平台）作为首要业务线同步上线，共同构筑自主可控的智能产品矩阵。',
                  right: true,
                },
              ].map((item) => (
