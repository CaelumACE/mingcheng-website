  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="py-16 md:py-20 bg-section relative">
        <div className="absolute inset-0 diag-grid opacity-50" />
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <div className="text-center mb-12 reveal">
            <span className="section-tag">合作伙伴</span>
            <p className="text-sm text-ink-muted mt-4">持续服务各行业客户</p>
          </div>
          <div className="reveal grid grid-cols-2 md:grid-cols-4 gap-4">
            {[1, 2, 3, 4].map((i) => (
              ...
              >
                <div className="text-ink-muted text-sm font-semibold tracking-wider opacity-40">
                  LOGO {i}
                </div>
              </div>
            ))}
